...
import { User, Mail, Lock, Phone, ArrowRight, Eye, EyeOff, Sparkles, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="relative w-full max-w-md animate-slideUp">
        <div style={cardStyle} className="p-8 rounded-2xl shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p style={{ color: textColor }} className="mt-2 opacity-70">
              Únete a la mejor plataforma de reservas
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p style={{ color: textColor }} className="opacity-70">
              ¿Ya tienes cuenta?{' '}
              <a href="/login" className="text-blue-500 hover:text-blue-600 font-semibold transition-colors">
                Inicia sesión aquí
              </a>
            </p>
          </div>
